///[ シェーダと描画コマンドの Code Pattern集 ]  
/////////////////////////////////////////////////////////////  
  
# 自前Blit
triangleで全画面描画(quadで描くと、対角線部分にtriangleの切れ目で 非効率的なスレッドが出来るのを避け、画面をはみ出す一つのtriangleで描く)  
SRP.Coreに追加されたBlitter機能は この最適化が入っているが多機能すぎる面もあり、シンプルに自前で全画面描画するなら
